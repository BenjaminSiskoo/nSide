auto CartPal::sufamiTurboManifest(const string& location) -> string {
  vector<uint8_t> buffer;
  concatenate(buffer, {location, "program.rom"});
  return sufamiTurboManifest(buffer, location);
}

auto CartPal::sufamiTurboManifest(vector<uint8_t>& buffer, const string& location) -> string {
...
auto CartPal::sufamiTurboImport(vector<uint8_t>& buffer, const string& location) -> bool {
