auto CartPal::gameBoyColorManifest(const string& location) -> string {
  vector<uint8_t> buffer;
  concatenate(buffer, {location, "program.rom"});
  return gameBoyColorManifest(buffer, location);
}

auto CartPal::gameBoyColorManifest(vector<uint8_t>& buffer, const string& location) -> string {
...
auto CartPal::gameBoyColorImport(vector<uint8_t>& buffer, const string& location) -> bool {
