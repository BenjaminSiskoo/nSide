auto CartPal::bsxSatellaviewManifest(const string& location) -> string {
  vector<uint8_t> buffer;
  concatenate(buffer, {location, "program.rom"});
  return bsxSatellaviewManifest(buffer, location);
}

auto CartPal::bsxSatellaviewManifest(vector<uint8_t>& buffer, const string& location) -> string {
...
auto CartPal::bsxSatellaviewImport(vector<uint8_t>& buffer, const string& location) -> bool {
