...
auto CartPal::superFamicomManifest(vector<uint8_t>& buffer, string location, string* firmwareMissing) -> string {
  string markup;
...
auto CartPal::superFamicomManifestScan(vector<Markup::Node>& roms, Markup::Node node) -> void {
