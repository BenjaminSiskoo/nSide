auto CartPal::superFamicomManifest(const string& location) -> string {
...
auto CartPal::superFamicomManifest(vector<uint8_t>& buffer, const string& location) -> string {
...
auto CartPal::superFamicomImport(vector<uint8_t>& buffer, const string& location) -> bool {
...
auto CartPal::superFamicomImportScanManifest(vector<Markup::Node>& roms, Markup::Node node) -> void {
