...
LibraryImport::LibraryImport() {
  setMargin(5);
  information.setText({
    "nSide, like higan, manages games in a library. To play a game, you must first import the game.\n"
...
void LibraryImport::onImportActivate() {
  if(program->auto_purify.open() == false) {
    MessageWindow().setText({
      "auto_purify must be installed to use this feature.\n",
