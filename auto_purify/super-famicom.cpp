...
string AutoPurify::createSuperFamicomDatabase(vector<uint8_t> &buffer, Markup::Node &document, const string &manifest) {
  string pathname = {
...
string AutoPurify::syncSuperFamicom(const string &pathname) {
