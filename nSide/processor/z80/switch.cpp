auto Z80::instruction() -> void {
  ...
  case 0xe3: print("Z80 opcode 0xe3 at $", hex(r[PC] - 1, 4L), "\n"); return op_xx();
  case 0xe4: print("Z80 opcode 0xe4 at $", hex(r[PC] - 1, 4L), "\n"); return op_xx();
  ...
  case 0xeb: print("Z80 opcode 0xeb at $", hex(r[PC] - 1, 4L), "\n"); return op_xx();
  case 0xec: print("Z80 opcode 0xec at $", hex(r[PC] - 1, 4L), "\n"); return op_xx();
  ...
  case 0xf4: print("Z80 opcode 0xf4 at $", hex(r[PC] - 1, 4L), "\n"); return op_xx();
  ...
  case 0xfc: print("Z80 opcode 0xfc at $", hex(r[PC] - 1, 4L), "\n"); return op_xx();
...
auto Z80::instructionED() -> void {
  uint8 opcode = read(r[PC]++);
  switch(opcode) {
  case 0x47: return op_ld_r_r(I, A);
  case 0x57: return op_ld_r_r(A, I);
  }
  print("Z80 opcode 0xed 0x", hex(opcode, 2L) , " at $", hex(r[PC] - 2, 4L), "\n");
  return op_xx();
}

auto Z80::instructionIndex(RegisterW& IR) -> void {
  uint8 opcode = read(r[PC]++);
  switch(opcode) {
  case 0x21: return op_ld_rr_nn(IR);
  case 0xcb: return op_ddcb();
  }
  print("Z80 opcode 0xdd 0x", hex(opcode, 2L) , " at $", hex(r[PC] - 2, 4L), "\n");
  return op_xx();
}

auto Z80::instructionIndexCB(RegisterW& IR) -> void {
  uint8 opcode = read(r[PC]++);
  print("Z80 opcode 0xdd 0xcb 0x", hex(opcode, 2L) , " at $", hex(r[PC] - 3, 4L), "\n");
  return op_xx();
}
